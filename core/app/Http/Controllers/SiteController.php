...
class SiteController extends Controller
{
    ...
    public function contactSubmit(Request $request)
    {
        ...
        // If user is logged in, redirect to ticket view, otherwise redirect to home
        if (auth()->check()) {
            return to_route('ticket.view', [$ticket->ticket])->withNotify($notify);
        }
        
        $notify[] = ['success', 'Your message has been sent successfully! We will get back to you soon. Your ticket number is: ' . $ticket->ticket];
        return back()->withNotify($notify);
    }
