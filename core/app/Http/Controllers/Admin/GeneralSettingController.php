...
class GeneralSettingController extends Controller {
    ...
    public function generalUpdate(Request $request) {
        $request->validate([
            ...
            'account_no_length'        => 'nullable|integer|min:1|max:100',
        ...
        $general->social_facebook = $request->social_facebook;
        $general->social_twitter = $request->social_twitter;
        $general->social_instagram = $request->social_instagram;
        $general->social_linkedin = $request->social_linkedin;
    ...
    public function systemConfigurationSubmit(Request $request) {
        ...
        $general->billing_codes_enabled = $request->billing_codes_enabled ? Status::ENABLE : Status::DISABLE;
        $general->rebate_system_enabled = $request->rebate_system_enabled ? Status::ENABLE : Status::DISABLE;
