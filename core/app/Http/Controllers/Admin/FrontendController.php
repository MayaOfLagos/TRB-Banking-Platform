...
class FrontendController extends Controller
{
    ...
    public function templates()
    {
        ...
        foreach ($temPaths as $key => $temp) {
            ...
            // Check for SVG preview for MayaOfLagos template, otherwise use JPG
            if ($tempname === 'MayaOfLagos' && file_exists($temp . '/preview.svg')) {
                $templates[$key]['image'] = asset($temp) . '/preview.svg';
            } else {
