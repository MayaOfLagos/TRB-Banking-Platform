...
class AdminRebateApproved extends Mailable
{
    ...
    public function build()
    {
        ...
        return $this->subject('Rebate Approved - User Notified - ' . $general->site_name)
                    ->markdown('templates.' . activeTemplateName() . '.mail.admin.rebate_approved')
                    ->with([
                        'rebate' => $this->rebate,
                        'user' => $this->user,
