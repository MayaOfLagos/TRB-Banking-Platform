...
class TierAdvancement extends Mailable
{
    ...
    public function build()
    {
        ...
        return $this->subject('Tier Advancement - Welcome to ' . $this->newTier . ' - ' . $general->site_name)
                    ->markdown('templates.' . activeTemplateName() . '.mail.tier_advancement')
                    ->with([
                        'user' => $this->user,
