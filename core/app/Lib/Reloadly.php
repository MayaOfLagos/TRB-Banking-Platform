...
class Reloadly
{
    ...
    public function getCountries()
    {
        ...
        // Decode JSON and ensure it returns a proper array/object
    ...
    public function getOperatorsByISO($iso)
    {
        ...
        // If decoding fails or returns non-array, return empty array
        if (json_last_error() !== JSON_ERROR_NONE || !is_array($decoded)) {
            return [];
        }
    ...
    public function getOperatorsByID($operatorId)
    {
        ...
        // If decoding fails or returns unexpected type, return null
