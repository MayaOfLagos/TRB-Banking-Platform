...
<div class="widget-two @if($box_shadow) box--shadow2 @endif b-radius--5 @if($cover_cursor && $link) has-link @endif bg--{{ $bg }}">
    ...
    <div class="widget-two__content">
        <h3 class="text-truncate" style="max-width: 100%;">{{ $value || $value === "0" || $value === 0 ? $value : __($heading) }}</h3>
        <p class="text-truncate" style="max-width: 100%;">{{ __($title ? $title : $subheading) }}</p>
    </div>
