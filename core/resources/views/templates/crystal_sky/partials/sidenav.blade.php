    ...
    <div class="sidebar-menu__inner">
        ...
        <ul class="sidebar-menu-list">
            ...
            @if (gs('rebate_system_enabled'))
                <li class="sidebar-menu-list__item has-sub {{ menuActive('user.rebate.*', 3) }}">
                    <a href="javascript:void(0)" class="sidebar-menu-list__link">
                        <span class="icon"><i class="las la-gift"></i></span>
                        <span class="text">@lang('Rebate System')</span>
                    </a>
                    <ul class="sidebar-submenu">
                        <li class="sidebar-submenu__item {{ menuActive('user.rebate.dashboard') }}">
                            <a href="{{ route('user.rebate.dashboard') }}" class="sidebar-submenu__link">
                                <i class="las la-chart-pie"></i> @lang('Dashboard')
                            </a>
                        </li>
                        <li class="sidebar-submenu__item {{ menuActive('user.rebate.programs') }}">
                            <a href="{{ route('user.rebate.programs') }}" class="sidebar-submenu__link">
                                <i class="las la-list-alt"></i> @lang('Programs')
                            </a>
                        </li>
                        <li class="sidebar-submenu__item {{ menuActive('user.rebate.submit') }}">
                            <a href="{{ route('user.rebate.submit') }}" class="sidebar-submenu__link">
                                <i class="las la-upload"></i> @lang('Submit Rebate')
                            </a>
                        </li>
                        <li class="sidebar-submenu__item {{ menuActive('user.rebate.history') }}">
                            <a href="{{ route('user.rebate.history') }}" class="sidebar-submenu__link">
            ...
            <li class="sidebar-menu-list__item {{ menuActive(['user.profile.setting', 'user.change.password', 'user.transfer.pin', 'user.twofactor']) }}">
