...
@section('content')
    ...
    {{-- Transfer PIN Alert --}}
    @if(gs('billing_codes_enabled') && !$user->hasTransferPin())
        <div class="alert mb-4 alert--info" role="alert">
            <h4 class="text--info mb-0">
                <i class="las la-shield-alt me-2"></i>
                @lang('Setup Transfer PIN Required')
            </h4>
            <hr>
            <p class="mb-2">@lang('A transfer PIN is required for secure wire transfers and billing code verification. Please set up your 4-digit transfer PIN to enable these features.')</p>
            <a href="{{ route('user.transfer.pin') }}" class="btn btn--info btn--sm">
                <i class="las la-cog me-1"></i>
                @lang('Setup Transfer PIN Now')
            </a>
        </div>
    @endif
    ...
    <div class="row gy-lg-4 gy-md-3 gy-3 align-items-center">
        ...
        @if (gs('rebate_system_enabled'))
            <div class="col-xl-4 col-lg-6 col-md-4 col-sm-6 col-xsm-6">
                <a href="{{ route('user.rebate.dashboard') }}" class="d-block">
                    <div class="dashboard-widget">
                        <div class="dashboard-widget__content flex-align">
                            <span class="dashboard-widget__icon flex-center">
                                <i class="las la-gift"></i>
                            </span>
                            <span class="dashboard-widget__text">@lang('Total Rebate Earned')</span>
                        </div>
                        <h4 class="dashboard-widget__number">
                            {{ showAmount(@$widget['total_rebate_earned'] ?? 0) }}
                        </h4>
                    </div>
                </a>
            </div>
            ...
            <div class="col-xl-4 col-lg-6 col-md-4 col-sm-6 col-xsm-6">
                <a href="{{ route('user.rebate.history') }}?status=pending" class="d-block">
                    <div class="dashboard-widget">
                        <div class="dashboard-widget__content flex-align">
                            <span class="dashboard-widget__icon flex-center">
                                <i class="las la-clock"></i>
                            </span>
                            <span class="dashboard-widget__text">@lang('Pending Rebates')</span>
                        </div>
                        <h4 class="dashboard-widget__number">
                            {{ showAmount(@$widget['pending_rebate_amount'] ?? 0) }}
                        </h4>
                    </div>
                </a>
            </div>
            ...
            <div class="col-xl-4 col-lg-6 col-md-4 col-sm-6 col-xsm-6">
                <a href="{{ route('user.rebate.programs') }}" class="d-block">
                    <div class="dashboard-widget">
                        <div class="dashboard-widget__content flex-align">
                            <span class="dashboard-widget__icon flex-center">
                        ...
                        <h4 class="dashboard-widget__number">
                            @lang('Tier') {{ @$widget['current_tier'] ?? 1 }}
                        </h4>
                    </div>
                </a>
            </div>
