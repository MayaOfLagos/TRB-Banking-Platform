...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-lg mx-auto">
        ...
        <div class="text-center mb-8">
            <h1 class="text-3xl font-bold text-gray-900 dark:text-white mb-2">@lang('Checkout.com Payment')</h1>
            <p class="text-gray-600 dark:text-gray-400">@lang('Secure payment processing with advanced fraud protection')</p>
        </div>
        ...
        <div class="checkout-container">
            <div class="payment-card">
                ...
                <div class="checkout-logo">
                    <h2>Checkout.com</h2>
                    <i class="las la-shield-alt" style="font-size: 2rem; color: #6366f1;"></i>
                </div>
                ...
                <!-- Payment Form -->
                <form role="form" class="checkout-payment-form" id="payment-form" method="{{ $data->method }}" action="{{ $data->url }}">
                    @csrf
                    ...
                    <button class="submit-btn" type="submit" id="checkout-submit-btn">
                ...
                <div class="security-badges">
                    ...
                    <div class="security-badge">
                        <i class="las la-robot security-icon"></i>
                        AI Fraud Detection
                    </div>
                </div>
            </div>
...
<script>
    ...
    (function($) {
        ...
        // Form submission
        $('.checkout-payment-form').on('submit', function(e) {
