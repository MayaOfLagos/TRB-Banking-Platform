...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-lg mx-auto">
        ...
        <div class="text-center mb-8">
            <h1 class="text-3xl font-bold text-gray-900 dark:text-white mb-2">@lang('Secure Card Payment')</h1>
            <p class="text-gray-600 dark:text-gray-400">@lang('Powered by Stripe - Your payment is secured with SSL encryption')</p>
        </div>
        ...
        <div class="stripe-container">
            <div class="payment-card">
                ...
                <div class="stripe-logo">
                    <h2>Stripe</h2>
                    <i class="las la-credit-card" style="font-size: 2rem; color: #635bff;"></i>
                </div>

                <!-- Payment Summary -->
                <div class="payment-summary">
                    <div class="summary-row">
                        <span class="summary-label">@lang('Amount')</span>
                        <span class="summary-value">{{ showAmount($deposit->amount) }} {{ gs('cur_text') }}</span>
                    </div>
                    <div class="summary-row">
                        <span class="summary-label">@lang('Processing Fee')</span>
                        <span class="summary-value">{{ showAmount($deposit->charge) }} {{ gs('cur_text') }}</span>
                    </div>
                    <div class="summary-row">
                        <span class="summary-label">@lang('Total Payable')</span>
                        <span class="summary-value">{{ showAmount($deposit->final_amount) }} {{ $deposit->method_currency }}</span>
                    </div>
                </div>
                ...
                <!-- Payment Form -->
                <form role="form" class="stripe-payment-form" id="payment-form" method="{{ $data->method }}" action="{{ $data->url }}">
                    @csrf
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            <label class="form-label">@lang('CVC')</label>
                            <div class="input-group">
                    ...
                    <button class="submit-btn" type="submit" id="stripe-submit-btn">
