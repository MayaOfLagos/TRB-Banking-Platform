    ...
    <div class="row mb-none-30">
        <div class="col-lg-12 col-md-12 mb-30">
            <form method="POST" action="{{ route('admin.setting.update') }}">
                ...
                <div class="card mt-3">
                    <div class="card-header">
                        <h6 class="card-title text-center">@lang('Contact Information')</h6>
                    </div>
                    <div class="card-body">
                        <div class="row">
                ...
                <div class="card mt-3">
                    <div class="card-header">
                        <h6 class="card-title text-center">@lang('Social Media Links')</h6>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="form-group col-sm-6">
                                <label>@lang('Facebook')</label>
                                <input class="form-control" name="social_facebook" type="url"
                                    value="{{ gs()->social_facebook }}" placeholder="https://facebook.com/yourpage">
                            </div>
                            <div class="form-group col-sm-6">
                                <label>@lang('Twitter')</label>
                                <input class="form-control" name="social_twitter" type="url"
                                    value="{{ gs()->social_twitter }}" placeholder="https://twitter.com/yourhandle">
                            </div>
                            <div class="form-group col-sm-6">
                                <label>@lang('Instagram')</label>
                                <input class="form-control" name="social_instagram" type="url"
                                    value="{{ gs()->social_instagram }}" placeholder="https://instagram.com/yourprofile">
                            </div>
                            <div class="form-group col-sm-6">
                                <label>@lang('LinkedIn')</label>
                                <input class="form-control" name="social_linkedin" type="url"
                                    value="{{ gs()->social_linkedin }}" placeholder="https://linkedin.com/company/yourcompany">
                            </div>
                        </div>
                    </div>
                </div>
