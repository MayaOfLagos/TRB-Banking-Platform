                ...
                <form action="{{ route('admin.setting.system.configuration.submit') }}" method="post">
                    ...
                    <div class="card-body">
                        <ul class="list-group">
                            ...
                            <li class="list-group-item d-flex flex-sm-nowrap justify-content-between align-items-center flex-wrap gap-2">
                                <div>
                                    <p class="fw-bold mb-0">@lang('Billing Codes System')</p>
                                    <p class="mb-0">
                                        <small>@lang('Enable billing codes (IMF, TAX, COT) verification for wire transfers. When enabled, users must complete billing codes verification before transfers are processed.')</small>
                                    </p>
                                </div>
                                <div class="form-group">
                                    <input name="billing_codes_enabled" data-width="100%" data-size="large" data-onstyle="-success" data-offstyle="-danger" data-bs-toggle="toggle" data-height="35" data-on="@lang('Enable')" data-off="@lang('Disable')" type="checkbox" @if (gs()->billing_codes_enabled) checked @endif>
                                </div>
                            </li>

                            <li class="list-group-item d-flex flex-sm-nowrap justify-content-between align-items-center flex-wrap gap-2">
                                <div>
                                    <p class="fw-bold mb-0">@lang('Rebate Banking System')</p>
                                    <p class="mb-0">
                                        <small>@lang('Enable the comprehensive rebate banking system. When enabled, users can participate in rebate programs, submit receipts for rebates, and earn cashback rewards based on their tier level.')</small>
                                    </p>
                                </div>
                                <div class="form-group">
                                    <input name="rebate_system_enabled" data-width="100%" data-size="large" data-onstyle="-success" data-offstyle="-danger" data-bs-toggle="toggle" data-height="35" data-on="@lang('Enable')" data-off="@lang('Disable')" type="checkbox" @if (gs()->rebate_system_enabled) checked @endif>
                                </div>
                            </li>
