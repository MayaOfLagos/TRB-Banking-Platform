...
use App\Http\Middleware\RebateRateLimiter;
...
return Application::configure(basePath: dirname(__DIR__))
    ...
    ->withMiddleware(function (Middleware $middleware) {
        ...
        $middleware->alias([
            ...
            'rebate.rateLimit'      => RebateRateLimiter::class,
    ...
    ->withExceptions(function (Exceptions $exceptions) {
        ...
        $exceptions->respond(function (Response $response) {
            ...
            // Redirect 404 errors on public routes to homepage
            if ($response->getStatusCode() === 404) {
                $path = request()->path();
                
                // Check if it's a public route (not admin, staff, user, or api)
                $protectedPrefixes = ['admin', 'staff', 'user', 'api', 'ipn'];
                ...
                // If it's a public route, redirect to homepage
                if (!$isProtectedRoute) {
